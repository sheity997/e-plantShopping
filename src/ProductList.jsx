            ...
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    ></path>
                        ...
                        <text              
                            x="130"          // poziția pe axa X în SVG
                        y="160"           // poziția pe axa Y în SVG
                        fontSize="100"    // dimensiunea textului
                        fill="white"       // culoarea textului
                        fontWeight="bold"
                        textAnchor="middle">
            ...
            {!showCart ? (
                <div>
                    {plantsArray.map((category, index)=>(
                        <div className='gategory-grid' key={index}>
                            <h1 style={{textAlign: 'center'}}> {category.category} </h1>
                            <div className='product-list'>
                                {category.plants.map((product, plantIndex)=>(
                                    <div className='product-card' key={plantIndex}>
                                        <img className="product-image" src={product.image} alt={product.name}/>
                                        <div className="product-title">{product.name}</div> 
                                        <div className="product-description">{product.description}</div> 
                                        <div className="product-cost">${product.cost}</div>
                                        <button className={`product-button ${addedToCart[product.name] ? 'added-to-cart' : ''}`} onClick={() => handleAddToCart(product)}>
